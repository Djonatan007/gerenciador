...
class FormNewTask extends StatefulWidget {
  ...
  FormNewTask({Key? key, this.tarefaAtual}) : super (key: key);

  @override
  FormNewTaskState createState() => FormNewTaskState();

}

class FormNewTaskState extends State<FormNewTask> {
